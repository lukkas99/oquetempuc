...
class TelaPrincipal extends StatefulWidget {
  ...
  TelaPrincipal({required this.userEmail, required this.userPassword});

  @override
  _TelaPrincipal createState() =>
      _TelaPrincipal(userEmail: userEmail, userPassword: userPassword);
}
...
class _TelaPrincipal extends State<TelaPrincipal> {
  final String userEmail;
  final String userPassword;
  _TelaPrincipal({required this.userEmail, required this.userPassword});
